...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto py-10 px-4">
        <div class="bg-white p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
            <h1 class="text-2xl font-bold mb-6">Add New Company</h1>
            ...
            <a href="{{ route('admin.company.index') }}" class="text-blue-600 hover:underline">&larr; Back</a>

            <form action="{{ route('admin.company.store') }}" method="POST" class="mt-6 space-y-4">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="companyDescription" id="companyDescription" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
